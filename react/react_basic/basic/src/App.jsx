...
function App() {
  return(
    <div>
      <Postcomponent1 name={"messi"}
      description={"wortld number 1 player "}
      num={"10"}
      
      />

      <Postcomponent1 name={"ronaldo"}
      description={"wortld number 1 player "}
      num="07"
...
function Postcomponent1(pros){
  const name=pros.name;
  const description=pros.description
  const num=pros.num;
  ...
  return (
    <div >
      ...
      <div>
        <p style={{backgroundColor:'white'}}> name of the player {name}</p>
        <br></br>
